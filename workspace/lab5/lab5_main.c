...
//    }
    ...
    //state machine for setting rcservo between 1500 and 4500
    if(rcservo_flag == 0){
       if(value < 4500)
           value += 10;
       else
...
//    SpibRegs.SPITXBUF = value; // something so you can see the pattern on the Oscilloscope
//    SpibRegs.SPITXBUF = value;
//
      //same as above in cpu timer 0 w/o the SpibRegs
//    if(rcservo_flag == 0){
//       if(value < 4500)
//           value += 10;
//       else
